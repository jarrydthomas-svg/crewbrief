/*
  THIS IS THE ONLY FILE YOU EDIT TO ADD OR CHANGE TRAINING VIDEOS.

  For each video, change:
  - youtubeId: the part after "youtu.be/" or after "v=" in a YouTube link
  - title, description, category and duration
